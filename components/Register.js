...
import { Container, Center, Heading, Text, VStack, Box, FormControl, Input, Link, Button, HStack, ScrollView } from "native-base";
            ...
            <Box safeArea px="1" py="8" w="90%" maxW="290">
                <VStack space={3} mt="5">
                    <FormControl isRequired isInvalid={'email' in errors}>
                        ...
                        <Input p={2} placeholder="example@mail.com" onChangeText={value => setFormData({...formData, 
                            email: value})}/>
                        {'email' in errors ?
                    ...
                    <FormControl isRequired isInvalid={'name' in errors}>
                        ...
                        <Input placeholder="Nombre" onChangeText={value => setFormData({...formData, 
                            name: value})} />
                        {'name' in errors ?
                    ...
                    <FormControl isRequired isInvalid={'lastname' in errors}>
                        ...
                        <Input placeholder="Apellido" onChangeText={value => setFormData({...formData, 
                             lastname: value})} />
                        {'lastname' in errors ?
                    ...
                    <FormControl isRequired isInvalid={'controlNumber' in errors}>
                        ...
                        <Input placeholder="00000000" onChangeText={value => setFormData({...formData, 
                            controlNumber: value})} />
